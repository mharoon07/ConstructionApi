...
const calculateGreyStructureCost = (req, res) => {
    ...
    try {
        ...
        const response = {
            ...
            results: {
                builtup_area,
                excavationCost: Number(excavationCost.toFixed(0)),
                cementCost: Number(cementCost.toFixed(0)),
                sandCost: Number(sandCost.toFixed(0)),
                aggregateCost: Number(aggregateCost.toFixed(0)),
                waterCost: Number(waterCost.toFixed(0)),
                steelCost: Number(steelCost.toFixed(0)),
                blockCost: Number(blockCost.toFixed(0)),
                backFillMaterialCost: Number(backFillMaterialCost.toFixed(0)),
                doorFrameCost: Number(doorFrameCost.toFixed(0)),
                electricalConduitingCost: Number(electricalConduitingCost.toFixed(0)),
                sewageCost: Number(sewageCost.toFixed(0)),
                miscellaneousCost: Number(miscellaneousCost.toFixed(0)),
                laborCost: Number(laborCost.toFixed(0)),
                projectManagementCost: Number(projectManagementCost.toFixed(0)),
                total_cost: Number(total_cost.toFixed(0)),
